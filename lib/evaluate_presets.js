...
export default function evaluatePresets(webpackPresets, webpackFormats, webpackRC, target, ...config) {
  ...
  const presets = Object.assign({}, webpackPresets(paths), webpackFormats(paths));
  const rootConfig = {
    resolve: {
      extensions: ['']
    }
